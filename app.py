...
@app.route('/classic')
def classic():
    return render_template('dashboardclassic.html')
...
@app.route('/games')
def games():
    return render_template('/games/games-index.html')

@app.route('/tictac')
def tictac():
    return render_template('/games/tictac/tic-tac.html')


@app.route('/lovetest')
def lovetest():
    return render_template('/games/lovetest/love-test.html')


@app.route('/mathtest')
def mathtest():
    return render_template('/games/mathtest/math-test.html')


@app.route('/magicsquare')
def magicsquare():
    return render_template('/games/magicsquare/magic-square.html')


@app.route('/hitthedot')
def hitthedot():
    return render_template('/games/hitthedot/hit-the-dot.html')
